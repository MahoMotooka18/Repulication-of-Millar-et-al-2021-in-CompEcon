...
Do not introduce hard clipping of $y$ or $z$ beyond normalization **unless** `model.enforce_bounds` is enabled; when enabled, clamp log states to the +/-2σ stationary bounds to match `Main_KS.ipynb`.
